...
export function tutorialScreen() {
  ...
  const steps = [
    {
      ic: '🌱', title: 'Welcome',
      body: `<strong>You Got This!</strong> is a free, private companion for your body, mind, and soul. There is no account and nothing to sign up for — just open it and begin. Everything you do stays on this device.`,
    },
    {
